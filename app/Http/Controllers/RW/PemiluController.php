...
class PemiluController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.rw.pemilu.index', $data);
    }
    ...
    {
        return view('pages.rw.pemilu.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('rw.pemilu.index');
    }
    ...
    public function show($id)
    {
        ...
        $calonRW = CalonPemilu::where('id_pemilu', $pemilu->id)->with('warga')->groupBy('id_warga')->select('id_warga', DB::raw('count(*) as total'))->get();
        ...
        return view('pages.rw.pemilu.detail', $data);
    }
