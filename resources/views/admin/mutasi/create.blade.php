    ...
    <div class="header-body">
        <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
                <h6 class="h2 text-white d-inline-block mb-0">Tambah Mutasi Warga</h6>
                <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                    <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Tambah Mutasi Warga</li>
                    </ol>
                </nav>
            </div>
        </div>
                        ...
                        <div class="w-100"></div>
                                <div class="col-lg-4 col-md-4 col-sm-12">
                                    <div class="form-group">
                                        <label for="input-mutasi" class="form-control-label">Pilih Warga</label>
                                        <select id="input-mutasi" class="form-control">
                                            <option>Pilih Warga</option>
                                            <option value="">Nashir 1</option>
                                            <option value="">Nashir 2</option>
                                            <option value="">Nashir 3</option>
                                            <option value="">Nashir 4</option>
                                            <option value="">Nashir 5</option>
                                        </select>
                                    </div>
                                </div>
                                <!-- Identitas Diri -->
                                <h2 class="my-4 text-primary">Identitas Warga</h2>
                                <div class="row ml-2">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="input-nik"
                                               placeholder="Masukan Nomor NIK" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="input-nkk"
                                               placeholder="Masukan Nomor No. Kartu Keluarga" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="w-100"></div>
