...
@section('content')
                ...
                <div class="row">
                    <div class="form-row col-lg-4 col-md-6 col-sm-12 mb-4">
                        ...
                        <select class="js-example-basic-multiple form-control" name="rts[]" multiple="multiple">
                            @for($i = 0; $i < 8; $i++)
                                <option value="{{$i}}">RT 00{{$i+1}}</option>
                            @endfor
                        </select>
                    </div>
                    <div class="w-100"></div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-default">
                <div class="card-body">
                    <ul class="nav nav-tabs nav-style-border pl-0 justify-content-between justify-content-xl-start bg-white"
                        role="tablist">
                        <li class="nav-item">
                    ...
                    <div class="tab-content">
                        <!--begin::Warga Tab-->
                        <div class="tab-pane pt-3 fade show active" id="warga" role="tabpanel"
                             aria-labelledby="warga-tab">
                            <div class="d-flex justify-content-between mb-4">
                                <p class="">Data Warga</p>
                                <div>
                                    <a href="/"
                                       target="" class="btn btn-outline-success btn-sm text-uppercase">
                                        <i class="fas fa-file-excel"></i> Export Excel
                                    </a>
                                    <a href="/"
                                       target="" class="btn btn-outline-info btn-sm text-uppercase">
