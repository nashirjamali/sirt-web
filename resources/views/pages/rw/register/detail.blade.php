    ...
    <div class="col-md-6 col-sm-12">
        <div class="card card-default">
            ...
            <div class="card-body">
                ...
                <a href="/rw/register/{{$register->id}}/edit?jenis=keluar" class="mr-2 btn btn-warning btn-pill text-white">
    ...
    <div class="col-md-6 col-sm-12">
        <div class="card card-default">
            ...
            <div class="card-body">
                ...
                <a href="/rw/register/{{$register->id}}/edit?jenis=masuk" class="mr-2 btn btn-warning btn-pill text-white">
                    <i class="mdi mdi-circle-edit-outline"></i>
                    Edit
                </a>
                <button class="btn btn-danger btn-pill text-white" data-toggle="modal" data-target="#deleteModal">
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form action="{{route('rw.register.destroy', $register->id)}}" method="post">
            @csrf
