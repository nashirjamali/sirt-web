                    ...
                    <table class="table dt-responsive nowrap data-table" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/rw/inventaris/{{$val->id}}?jenis=barang" class="btn btn-sm text-white btn-primary">Detail</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
                    ...
                    <table class="table dt-responsive nowrap data-table" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/rw/inventaris/{{$val->id}}?jenis=perpustakaan" class="btn btn-sm text-white btn-primary">Detail</a>
                                </td>
                            </tr>
                            @php $no++; @endphp
                            @endforeach
                    ...
                    <table class="table dt-responsive nowrap data-table" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$val->tgl_dimiliki}}</td>
                                <td>
                                    <a href="/rw/inventaris/{{$val->id}}?jenis=tanah_bangunan" class="btn btn-sm text-white btn-primary">Detail</a>
                                </td>
                            </tr>
                            @php $no++; @endphp
                            @endforeach
                    ...
                    <table class="table dt-responsive nowrap data-table" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$val->tgl_dimiliki}}</td>
                                <td>
                                    <a href="/rw/inventaris/{{$val->id}}?jenis=atk" class="btn btn-sm text-white btn-primary">Detail</a>
                                </td>
                            </tr>
                            @php $no++; @endphp
                            @endforeach
