...
@endif
<form id="form" method="POST" action="{{route('rw.pengumuman.update', $pengumuman->id)}}">
    @csrf
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="form-row col-lg-6 col-md-6 col-sm-12 mb-4">
                            ...
                            <input class="form-control" value="{{$pengumuman->judul_pengumuman}}" required name="judul"></input>
                        </div>
                        <div class="form-row col-lg-12 col-md-12 col-sm-12 mb-4">
                            <label>Isi Pengumuman</label>
                            <textarea class="form-control" rows="10" placeholder="Masukan isi pengumuman" required name="isi">{{$pengumuman->isi_pengumuman}}</textarea>
                        </div>
                        <div class="w-100"></div>
                    </div>
