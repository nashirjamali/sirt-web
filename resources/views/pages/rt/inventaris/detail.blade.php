    ...
    <div class="col-12">
        <div class="card card-default">
            ...
            <div class="card-body">
                ...
                <a href="/rt/inventaris/{{$inventaris->id}}/edit?jenis={{$jenis}}" class="mr-2 btn btn-warning btn-pill text-white">
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form action="{{route('rt.inventaris.destroy', $inventaris->id)}}" method="post">
            @csrf
