...
@push('page-title')
RT - Detail Mutasi Warga
@endpush
@section('content')
<div class="breadcrumb-wrapper">
    <h1 class="mb-2">Detail Mutasi Warga</h1>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb p-0">
            ...
            <li class="breadcrumb-item" aria-current="page">Detail Mutasi Warga</li>
        </ol>
    </nav>
</div>
<div class="row">
            ...
            <div class="card-body">
                <div class="form-row mb-4">
                    <div class="col-12 mb-4">
                        ...
                        <div class="w-100"></div>
                        <h5 class="text-dark">{{$warga->mutasi->status}}</h5>
                    </div>
                    <div class="w-100"></div>
                    <div class="col-12 mb-4">
                        <label for="">Tanggal</label>
                        <div class="w-100"></div>
                        <h5 class="text-dark">{{$warga->mutasi->tgl_mutasi}}</h5>
                    </div>
                </div>

                <a href="/rt/mutasi/{{$warga->id}}/edit" class="mr-2 btn btn-warning btn-pill text-white">
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form action="{{route('rt.mutasi.destroy', $warga->id)}}" method="post">
            @csrf
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h6>
                        Anda akan <span class="text-dark">menghapus status Mutasi</span> untuk {{$warga->nama}} <br>
                    </h6>
                </div>
